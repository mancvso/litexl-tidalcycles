WIP: plugin to interact with tidalcycles via lite-xl using a managed litexl.core.process API instance, as I will need to constantly read input and poutput of long-lived child process.
...
Litexl does a very good job at rendering and uses just a fraction of resources that Pulsar required.
